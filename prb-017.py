...
#
"""
задача:  https://projecteuler.net/problem=17
перевод: http://euler.jakumo.org/problems/view/17.html
...
число 115 (one hundred and fifteen) - из 20 букв. Использование "and" при записи чисел соответствует
