...
#
"""
задача:  https://projecteuler.net/problem=27
перевод: http://euler.jakumo.org/problems/view/27.html
...
Однако, при n=40, 40^2+40+41=40(40+1)+41 делится на 41 без остатка, и, очевидно, при n=41,41^2+41+41
делится на 41 без остатка.

При помощи компьютеров была найдена невероятная формула n^2−79n+1601, согласно которой можно получить 80 простых
